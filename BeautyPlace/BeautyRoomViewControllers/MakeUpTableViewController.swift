...
//    let realm = try! Realm()
//    lazy var new: Results<BeautyRooms> = { self.realm.objects(BeautyRooms.self).sorted(byKeyPath: "name", ascending: true)}().filter("typesOfServices.name == 'MakeUp'")
...
//    }
//}
//extension MakeUpTableViewController: UISearchResultsUpdating {
